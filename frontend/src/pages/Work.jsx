            ...
            >
              ...
              <div className="project-meta">
                ...
                <div className="block-reveal projects block-reveal--active bg-transparent">
                  ...
                  <br />
                  <span className="arr italic text-sm">
                    → A stationery ecommerce website built using MERN stack with
                    a modern design and user-friendly interface.
                  </span>
                </div>
          ...
          >
            ...
            <div className="project-meta">
              ...
              <div className="block-reveal projects block-reveal--active bg-transparent">
                ...
                <br />
                <span className="arr italic text-sm">
                  → A Twitter clone built with MERRN stack that allows users to
                  post tweets, follow others, and interact with content.
                </span>
              </div>
